...
{
    public abstract class BoilerPlateMvcWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BoilerPlateMvcWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BoilerPlateMvcWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BoilerPlateMvcDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BoilerPlateMvcDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BoilerPlateMvcDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BoilerPlateMvcDbContext, Task<T>> func)
        {
            T result;
